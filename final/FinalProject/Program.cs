...
class Program
{
    static void Main(string[] args)
    {
       ...
       5- It's quite easy to end the application by selecting 5. I'm thrilled to have a better understanding of programming with class. I will continue to improve my understanding.
